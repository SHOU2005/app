      ...
      <div style={{ padding: '0 20px' }}>
        ...
        {step === 2 && (
          <>
            ...
            {error && <p style={{ color: '#EF4444', fontSize: 13 }}>{error}</p>}
            <button className="btn btn-primary btn-lg btn-full" style={{ marginTop: 8, background: T1, borderRadius: 14 }} onClick={submit} disabled={loading}>
              {loading ? t('registering') : t('registerEmployer')}
            </button>
          </>
        )}
