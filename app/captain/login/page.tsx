  ...
  return (
    <div style={{ fontFamily: FONT, minHeight: '100vh', background: '#F8F8F8', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, background: '#FFFFFF', borderRadius: '24px 24px 0 0', marginTop: -16,
        ...
        {stage === 'phone' ? (
          <>
            ...
            <div style={{ display: 'flex', alignItems: 'center', border: `1.5px solid ${phoneOk ? '#111111' : 'rgba(0,0,0,0.12)'}`,
              borderRadius: 14, background: '#FAFAFA', marginBottom: 16, overflow: 'hidden' }}>
        ...
        <p style={{ textAlign: 'center', fontSize: 14, color: 'rgba(0,0,0,0.45)', margin: '20px 0 0' }}>
          {t('newCaptain')}{' '}
          <a href="/captain/register" style={{ color: '#111111', fontWeight: 800, textDecoration: 'none' }}>{t('createAccount')} →</a>
        </p>
      </div>
    </div>
  )
